...
# Wichtiger Hinweis: Die String-Texte wurden mt ChatGPT verbessert
def run_data_loading_root(language_index,title):
    import streamlit as st
    import Data_Loading_Elective_Modules_from_Module_Handbook
    import Data_Loading_Model_Training_Data
    import Data_Loading_Columns_Info
    import Data_Loading_Student_Mandatory_Modules_Grades_Data
    ...
    # Modell-Training Daten für Notenprognose
    if data_type == options[0]:
        ...
        Data_Loading_Model_Training_Data.run_data_loading_model_training_data(language_index,data_type)
    ...
    # Wahlpflichtfächer Informations aus dem Modulhandbuch
        ...
        Data_Loading_Elective_Modules_from_Module_Handbook.run_data_loading_elective_modules_from_module_handbook(language_index,data_type)
    ...
    # Spalten Informationen
        ...
        Data_Loading_Columns_Info.run_data_loading_columns_info(language_index,data_type)
    ...
    # Studenten Daten (Noten von Pflichtfächern)
        ...
        Data_Loading_Student_Mandatory_Modules_Grades_Data.run_data_loading_student_mandatory_modules_grades_data(language_index,data_type)
