# Wichtiger Hinweis: Die String-Texten wurden mit ChatGPT erstellt
def run_model_training_grades_prediction(language_index):
    ...
    def get_columns_info():
        ...
        strengths_info = list(columns_info_data[columns_info_data['Beschreibung'] == 'Stärke']['Spalte'])
    ...
    strengths_columns, mandatory_modules_columns, elective_modules_columns = get_columns_info()


    # Features und Target Spalten festlegen
    X_columns = mandatory_modules_columns
    y_columns = elective_modules_columns
    ...
    if st.button("Daten vorverabeiten und Modell traininieren"):
        ...
        # Fülle die Null-Werte, bzw. nicht geschriebene Wahlpflichtfächer mit IterativeImputer unter Nutzung des BayesianRidge (Linear Regression)
