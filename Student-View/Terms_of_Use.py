...
def run_terms_of_use(language_index):
    ...
    translations_terms_of_use = {
        1: [
            "Welcome to our project (OptiModuls)", "Willkommen zu unserem Projekt (OptiModuls)", "Benvenuto nel nostro progetto (OptiModuls)",
            "Bienvenue dans notre projet (OptiModuls)", "Bienvenido a nuestro proyecto (OptiModuls)",
            "Bem-vindo ao nosso projeto (OptiModuls)", "Välkommen till vårt projekt (OptiModuls)", "Velkommen til vårt prosjekt (OptiModuls)",
            "Velkommen til vores projekt (OptiModuls)", "Witamy w naszym projekcie (OptiModuls)",
            "Добро пожаловать в наш проект (OptiModuls)", "Ласкаво просимо до нашого проекту (OptiModuls)"
        ],
        2: [
